...
namespace SrvGesInj.Clases
{
    class cPedidosVenta
    {
        ...
        public class CabVenta : Entidad
        {
            ...
            public decimal DtpPP
            {
                get { return _DtpPP; }
                set
                {
                    sbrPropiAdi("DtpPP", _DtpPP.ToString(), value.ToString());
                    _DtpPP = value;
                }
            }
            ...
            public int fncAlta()
            {
                ...
                string vNumSerie = SQLDataAccess.GenTraeNumSerie(cParamXml.NSerPedCli, true, cParamXml.strConec);
            ...
            public bool fncAlta(DataRow dr)
            {
                bool vOk = false;
                ...
                {
                    _Error = "Error al dar de Alta la Cabecera de Pedido:" + vSql;
                }
            ...
            using (SqlConnection vConnec = new SqlConnection(cParamXml.strConecProduc_Prueb))
            {
                ...
                if (dr.HasRows == true) while (dr.Read())
                        listaLineas.Add(new LinVenta((int)dr[0], (int)dr[1], (int)dr[2], (int)dr[3], dr[4].ToString(), dr[5].ToString(),
                                                    ...
                                                    (Decimal)dr[11], (Decimal)dr[12], (Decimal)dr[13], (Decimal)dr[14]));
                vConnec.Close();
            }
            ...
            public bool fncAltaLin(DataRow dr)
            {
                ...
                for (int i = 0; i < vNumCampos; i++)
                {
                    ...
                    else
                    {
                        ...
                        if (vTipo == "System.Double") vDato = vDato.Replace(",", ".");
