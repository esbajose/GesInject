...
namespace GesInject.Clases
{
    class cConfig
    {
        ...
        private const string Sql_Busca = "Select Valor From PlantillaProyec_config where Clave = '[?1]'";
        private const string Sql_Modif = "Update PlantillaProyec_config set Valor = '[?2]' where Clave = '[?1]'";
        private const string Sql_Alta = "insert into PlantillaProyec_config Values('[?1]','[?2]')";
